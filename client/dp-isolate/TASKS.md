...
- [ ] display the request in the DP isolate UI in addition to the response;
- [ ] refactor the Playwright demo so validation/error scenarios run first and the successful scenario runs last; this should remove the need for cleanup/reset in the middle of the demo;
